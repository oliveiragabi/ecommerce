            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/ecommerce/index.php/cart">Carrinho - <span class="cart-amunt"> R$<?php echo getCartVlSubTotal(); ?> </span> <i class="fa fa-shopping-cart"></i> <span class="product-count"> <?php echo getCartNrQtd(); ?> </span></a>
                    </div>
                </div>
            </div>
        </div>
