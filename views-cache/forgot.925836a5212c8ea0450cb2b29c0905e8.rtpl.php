...
<div class="lockscreen-wrapper">
  ...
  <div class="lockscreen-item">
    ...
    <form  action="/ecommerce/index.php/admin/forgot" method="post">
  ...
  <div class="help-block text-center">
    Digite seu e-mail e receba as instrucoes para redefinir a sua senha.
  </div>
  <div class="text-center">
    <a href="/ecommerce/index.php/admin/login">Entre com um usuario diferente</a>
  </div>
...
<!-- jQuery 2.2.3 -->
<script scr="/ecommerce/res/admin/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script scr="/ecommerce/res/admin/bootstrap/js/bootstrap.min.js"></script>
</body>
</html>
