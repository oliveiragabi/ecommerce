  	...
  	<div class="col-md-12">
  		<div class="box box-primary">
            ...
            <div class="box-header">
              <a href="/ecommerce/index.php/admin/categories/create" class="btn btn-success">Cadastrar Categoria</a>
              <div class="box-tools">
                <form action="/ecommerce/index.php/admin/categories">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="/ecommerce/index.php/admin/categories/<?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
