...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="/ecommerce/admin/categories/create">Cadastrar</a></li>
  </ol>
</section>
        ...
        <form role="form" action="/ecommerce/index.php/admin/products/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="desurl" name="desurl" step="0.00" placeholder="htttp://">
            </div>
          </div>
          <!-- /.box-body -->
