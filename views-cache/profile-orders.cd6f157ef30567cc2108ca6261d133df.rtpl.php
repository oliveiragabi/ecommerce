                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width:222px;">
                                <a class="btn btn-success" href="/ecommerce/index.php/order/<?php echo htmlspecialchars( $value1["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" role="button">Imprimir Boleto</a>
                                <a class="btn btn-default" href="/ecommerce/index.php/profile/orders/<?php echo htmlspecialchars( $value1["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" role="button">Detalhes</a>
                            </td>
                        </tr>
                        <?php }else{ ?>
